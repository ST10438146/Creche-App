...
class UserPaymentsFragment : Fragment() {
    ...
    companion object {
        fun newInstance(userId: String) = UserPaymentsFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = SimpleListAdapter(emptyList(), binder = { map, holder ->
            holder.titleTv.text = "Amount: ${map["amount"] ?: "0"}"
            holder.subtitleTv.text = "Status: ${map["status"] ?: "N/A"}  Date: ${map["date"] ?: "N/A"}"
        })
